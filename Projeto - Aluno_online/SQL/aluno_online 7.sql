...
--
-- Host: 127.0.0.1
-- Tempo de geração: 15-Nov-2023 às 02:13
...
(1, 1, '0000-00-00', 1, 3, 1),
(6, 1, '2023-11-14', NULL, 6, 2),
(7, 1, '2023-11-14', NULL, 5, 1);
...
INSERT INTO `disciplina_has_usuario` (`id_disciplina`, `idusuario`, `datacadastro`, `ativo`) VALUES
(1, 3, '2023-11-15 00:00:00', 1),
(1, 5, '2023-11-15 00:00:00', 1),
(2, 6, '2023-11-15 00:00:00', 1),
(3, 7, '2023-11-15 00:00:00', 1),
(3, 8, '2023-11-15 00:00:00', 1),
(3, 9, '2023-11-15 00:00:00', 1);
...
--
ALTER TABLE `diario`
  MODIFY `id_diario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
