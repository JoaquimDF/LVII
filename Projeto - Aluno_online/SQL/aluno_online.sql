...
--
-- Host: 127.0.0.1
-- Tempo de geração: 16/10/2024 às 03:44
...
(4, 'Danilo Carlos ', 202301, '1998-05-13', 'QNN 21 Conjunto E casa 17', 'danilo@email.com', '05700843188', 'Danilo', 'profJoaquim', '123456', 1, 2),
...
--
ALTER TABLE `diario`
  MODIFY `id_diario` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave primaria de diario.', AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT de tabela `disciplina`
--
ALTER TABLE `disciplina`
  MODIFY `id_disciplina` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave primaria de disciplina.', AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de tabela `disciplina_has_usuario`
--
ALTER TABLE `disciplina_has_usuario`
  MODIFY `id_dhu` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave primaria de disciplina_has_usuario.', AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT de tabela `notas`
--
ALTER TABLE `notas`
  MODIFY `idnotas` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave primaria da tabela Notas', AUTO_INCREMENT=8;
