...
--
-- Host: 127.0.0.1
-- Tempo de geração: 26/11/2023 às 20:18
...
CREATE TABLE `disciplina_has_usuario` (
  ...
  `datacadastro` date COMMENT 'Campo que recebe a data de cadastro.',
  `ativo` int(11) DEFAULT 1 COMMENT '1=ativo\\ 0=inativo'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
--
ALTER TABLE `diario`
  MODIFY `id_diario` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave primaria de diario.', AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de tabela `disciplina`
--
ALTER TABLE `disciplina`
  MODIFY `id_disciplina` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave primaria de disciplina.', AUTO_INCREMENT=12;
...
--
ALTER TABLE `notas`
  MODIFY `idnotas` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave primaria da tabela Notas', AUTO_INCREMENT=7;
