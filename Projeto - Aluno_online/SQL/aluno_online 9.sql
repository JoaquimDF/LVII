...
--
-- Host: 127.0.0.1
-- Tempo de geração: 24/11/2023 às 20:42
...
CREATE TABLE `perfil` (
  `idperfil` int(11) NOT NULL COMMENT '1=admin2=professor3=aluno',
...
(3, 'Alberto', 1234, '2000-03-12', 'teste2', 'teste2@teste2', 'teste2', 'teste2', 'Alberto', '202cb962ac59075b964b07152d234b70', NULL, 3),
(4, 'Danilo Carlos ', 202301, '1998-05-13', 'QNN 21 Conjunto E casa 17', 'danilo@email.com', '05700843188', 'Danilo', 'profDanilo', '123456', NULL, 2),
(5, 'Jose Silva', 202302, '1999-05-14', 'QNN 23 Conjunto J casa 19', 'josesilva@email.com', '00000000000', 'Jose Silva', 'alunoJose', '202cb962ac59075b964b07152d234b70', NULL, 3),
...
--
ALTER TABLE `diario`
  MODIFY `id_diario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `disciplina_has_usuario`
  MODIFY `id_dhu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
