...
--
-- Host: 127.0.0.1
-- Tempo de geração: 25/11/2023 às 16:42
...
CREATE TABLE `notas` (
  ...
  `notas` decimal(10,0) DEFAULT NULL COMMENT 'Campo que recebe as notas do usuario.',
...
(9, 'Renato', 123, '1999-05-14', 'QNN 23 Conjunto J casa 19', 'josesilva@email.com', '00000000000', 'Danilo', 'renato', '123', 0, 3);
...
--
ALTER TABLE `curso`
  MODIFY `idcurso` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave primaria do curso.', AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de tabela `diario`
--
ALTER TABLE `diario`
  MODIFY `id_diario` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave primaria de diario.', AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de tabela `disciplina`
--
ALTER TABLE `disciplina`
  MODIFY `id_disciplina` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave primaria de disciplina.', AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de tabela `disciplina_has_usuario`
--
ALTER TABLE `disciplina_has_usuario`
  MODIFY `id_dhu` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave primaria de disciplina_has_usuario.', AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de tabela `notas`
--
ALTER TABLE `notas`
  MODIFY `idnotas` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave primaria da tabela Notas';
...
--
ALTER TABLE `usuario`
  MODIFY `idusuario` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave Primaria da tabela Usuario.', AUTO_INCREMENT=12;
