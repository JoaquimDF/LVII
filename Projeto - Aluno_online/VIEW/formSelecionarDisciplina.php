    ...
    <center>
        <div class="container">
            <div class="card bg-dark text-white font-weight-bold text-center">
                <div class="card-body" style="font-size: 15pt;">Cadastro de Diário</div>
            </div>
            <br>
            <div class="jumbotron">
                <div class="card-group">
                    <form action="formCadastroDiario.php" method="get">
                            ...
                            <div class="card-body text-white">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <label for="datacadastro" class="font-weight-bold text-warning">Selecione a data:</label>
